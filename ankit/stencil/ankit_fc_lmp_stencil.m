...
LD.FC3.id = load('./FULLorder3.dat');
%LD.FC4.id = load('./FULLorder4.dat');
...
%increment position for iFC,2
    LD.pos_tmp(LD.FC2.id(iFC,2)+1, LD.FC2.id(iFC,4) +1 ) = ...
        LD.pos_tmp(LD.FC2.id(iFC,2)+1, LD.FC2.id(iFC,4) +1 ) + 2*LD.dx;
%calc changed force    
...
%change in force on alpha
    LD.FC2.phi(iFC) =...
        -...
        (...
        -LAMMPS.force1(LD.FC2.id(iFC,1) + 1 , LD.FC2.id(iFC,3) ) + ...
        8*LAMMPS.force2(LD.FC2.id(iFC,1) + 1 , LD.FC2.id(iFC,3) ) - ...
        8*LAMMPS.force3(LD.FC2.id(iFC,1) + 1 , LD.FC2.id(iFC,3) ) + ...
        LAMMPS.force4(LD.FC2.id(iFC,1) + 1 , LD.FC2.id(iFC,3) ) ...
        )...
        / (12*LD.dx);
%--------------------------------------------------------------------------
%pause  
...
%increment position beta
    LD.pos_tmp(LD.FC3.id(iFC,2) + 1 , LD.FC3.id(iFC,5) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,2) + 1 , LD.FC3.id(iFC,5) + 1 ) + 2*LD.dx;
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) + 2*LD.dx;
%calc changed force
    LAMMPS.force1 = ankit_lmp_force(LD);
...
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) - 2*LD.dx;
%calc changed force
    LAMMPS.force8 = ankit_lmp_force(LD);
...
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) + 2*LD.dx;
%calc changed force
    LAMMPS.force9 = ankit_lmp_force(LD);
...
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) + LD.dx;
%calc changed force
    LAMMPS.force10 = ankit_lmp_force(LD);
...
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) - LD.dx;
%calc changed force
    LAMMPS.force11 = ankit_lmp_force(LD);
...
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) - 2*LD.dx;
%calc changed force
    LAMMPS.force12 = ankit_lmp_force(LD);
...
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) + 2*LD.dx;
%calc changed force
    LAMMPS.force13 = ankit_lmp_force(LD);
...
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) + LD.dx;
%calc changed force
    LAMMPS.force14 = ankit_lmp_force(LD);
...
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) - LD.dx;
%calc changed force
    LAMMPS.force15 = ankit_lmp_force(LD);
...
%increment position gamma
    LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) = ...
        LD.pos_tmp(LD.FC3.id(iFC,3) + 1 , LD.FC3.id(iFC,6) + 1 ) - 2*LD.dx;
%calc changed force
    LAMMPS.force16 = ankit_lmp_force(LD);
...
%change in force on alpha
    LD.FC3.phi(iFC) =...
        ...
        8*LAMMPS.force2(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) - ...
        8*LAMMPS.force3(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) + ...
        LAMMPS.force4(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) ...
        )...
        / (144*LD.dx^2)...
        ...
        - 8*(...
        -LAMMPS.force5(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) + ...
        8*LAMMPS.force6(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) - ...
        8*LAMMPS.force7(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) + ...
        LAMMPS.force8(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) ...
        )...
        / (144*LD.dx^2)...	
        ...
        +8*(...
        -LAMMPS.force9(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) + ...
        8*LAMMPS.force10(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) - ...
        8*LAMMPS.force11(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) + ...
        LAMMPS.force12(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) ...
        )...
        / (144*LD.dx^2) +...
        ...
        -(...
        -LAMMPS.force13(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) + ...
        8*LAMMPS.force14(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) - ...
        8*LAMMPS.force15(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) + ...
        LAMMPS.force16(LD.FC3.id(iFC,1) + 1 , LD.FC3.id(iFC,4) ) ...
        )...
        / (144*LD.dx^2)...
        ;
%--------------------------------------------------------------------------
